...
class Hexagram(BaseTalent):
    ...
    def execute_t0(self, player):
        ...
        target_name = display.prompt_choice("选择猜拳对手：", names)
    ...
    def _both_scissors(self, player):
        ...
        names = [p.name for p in others]
        choice = display.prompt_choice("天雷！选择承受伤害的玩家：", names)
    ...
    def _both_rock(self, player):
        ...
        choice = display.prompt_choice("选择获得的护甲：", available)
